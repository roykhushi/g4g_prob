<h2><a href="https://www.geeksforgeeks.org/problems/palindrome-string0817/1?page=1&category=Arrays,Strings&company=Amazon,Microsoft,Flipkart,Adobe,Google,Samsung,Snapdeal,Paytm,Goldman%20Sachs,Morgan%20Stanley,D-E-Shaw,Oracle,SAP%20Labs,Qualcomm,Wipro,Atlassian,Infosys,Uber&difficulty=Easy&sortBy=submissions">Palindrome String</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>S</strong>, check if it is palindrome or not.</span></p>
